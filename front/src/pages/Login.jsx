...
const Login = () => {
  ...
  useEffect(() => {
    ...
    if (urlError) {
      const errorMessages = {
        'no_email': 'No se pudo obtener el email de tu cuenta. Intenta con otro método.',
        'github_error': 'Error de conexión con GitHub. Intenta nuevamente.',
        'google_error': 'Error de conexión con Google. Intenta nuevamente.',
      };
