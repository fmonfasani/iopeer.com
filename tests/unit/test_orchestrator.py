...
from agenthub.orchestrator import Orchestrator, AgentRegistry, WorkflowRegistry
...
class TestWorkflowRegistry:
    def test_register_workflow(self):
        ...
        registry.register("test_workflow", {
            "tasks": ["agent1.action1", "agent2.action2"]
        })
...
class TestOrchestrator:
    def test_send_message(self):
        ...
        result = orchestrator.send_message("mock_agent", {
            "action": "test_action",
            "data": {"test": "data"}
        })
