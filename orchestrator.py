...
class Orchestrator:
    ...
    def register_workflow(self, name: str, tasks: List[str], 
                         parallel: bool = False, timeout: int = None):
        """
        Registra un workflow
    ...
    def _execute_sequential_workflow(self, workflow: Dict[str, Any], 
    ...
    def _execute_parallel_workflow(self, workflow: Dict[str, Any], 
                                  context: Dict[str, Any], 
                                  execution_id: str) -> Dict[str, Any]:
